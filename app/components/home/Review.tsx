...
//   return (
//     <>
//       <div className="min-h-screen justify-center items-center pt-14">
//         <div className="text-center space-y-2">
//           <h1 className="text-lg text-[#f6520a] font-semibold">Testimonials</h1>
//           <p className="text-4xl font-bold pb-3">
//             What our students say <br /> about Colleges
//           </p>
...
//                       xmlns="http://www.w3.org/2000/svg"
//                       fill="currentColor"
//                       className="block w-5 h-5 text-[#f6520a] mb-4"
