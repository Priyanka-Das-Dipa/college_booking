  ...
  return (
    <div className="container mx-auto w-full max-w-md space-y-4 rounded-lg border bg-white p-10 shadow-lg dark:border-zinc-700 dark:bg-zinc-900">
      ...
      <form action="#" className="space-y-6">
        ...
        <button className="w-full rounded-md bg-[#f6520a] px-4 py-2 text-white transition-colors hover:bg-[#f62a0a] dark:bg-sky-700">
          Submit
        </button>
      </form>
      <p className="text-center text-sm text-zinc-700 dark:text-zinc-300">
        Don&apos;t have an account?
        <Link to="/login" className="font-semibold underline text-[#f6520a]">
          <span> </span> SignIn
        </Link>
      </p>
